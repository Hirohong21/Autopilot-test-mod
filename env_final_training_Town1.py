...
class CarlaEnv(gym.Env):
    def __init__(self, config=ENV_CONFIG):
        ...
        self.scenario_list = ['FollowLeadingVehicle', 'FollowLeadingVehicleWithObstacle', 'VehicleTurningRight',
                              'VehicleTurningLeft']
    ...
    def init_server(self):
        ...
        self.server_process = subprocess.Popen(
            [
                "/home/sdc/Desktop/carla94/CarlaUE4.sh", "/Game/Carla/Maps/Town01", "-benchmark", '-fps=20'
   ...
   #  @set_timeout(10)
    ...
    def write_result(self, times):
        ...
        filename = 'Town1_training_result' + ".txt"

        if times == 1:
            with open(filename, "a+") as fd:

                fd.write('========== Start tarning TOWN1 ! '+current_time+'==========\n')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        obs, reward, done, info = env.step([0.75, 0])    #just go straight
        R += reward
        print(R)
